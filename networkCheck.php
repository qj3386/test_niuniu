...
if (network_check("http://fc.xyabb.com")) {
	...
	$smtpusermail = '123467@sina.com';//SMTP服务器的用户邮箱
	$smtpemailto = '123467@qq.com';//发送给谁
	$smtpuser = "123467@sina.com";//SMTP服务器的用户帐号
	$smtppass = "123467";//SMTP服务器的用户密码
