...
class ProjectFarm extends Base
{
    ...
    {
        $list = model('ProjectFarm')->tree_to_list(model('ProjectFarm')->list_to_tree());
    ...
    public function add()
    {
        ...
        if ($parent_id != 0) {
            ...
            $this->assign('parent_project_type', model('ProjectFarm')->getOne(['id'=>$parent_id]));
        }
