...
use app\common\model\ProjectFarm;

class ProjectFarmLogic extends BaseLogic
{
    ...
    {
        return new ProjectFarm();
    }

    public function getValidate()
    {
        return Loader::validate('ProjectFarm');
    }
    ...
    public function del($where)
    {
        ...
        $where_project['type_id'] = $record['id'];
        model('Project')->del($where_project);
        // 提交事务
        Db::commit();
        return ReturnData::create(ReturnData::SUCCESS);
    }
